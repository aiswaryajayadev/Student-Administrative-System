...
<button class="button button1"><a href="getattendance.php"class="two" >Attendance</a></button>
<button class="button button1"><a href="new 1.php"class="two" >Upload Course Materials</a></button>
<button class="button button1"><a href="assingment.php"class ="two">Set assingment</a>
 </div>
</body>
</html>
